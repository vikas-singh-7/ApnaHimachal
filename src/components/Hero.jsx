...
const Hero = () => {
  return (
         ...
         <div className='md:h-[80vh] max-sm:h-[50vh] w-[100vw] bg-[url("./images/heroImage.webp")]  bg-center bg-cover relative max-sm:bg-[url("./images/heromobile.webp")]'>
        <div className="absolute left-[50%] top-[50%] -translate-y-[50%] -translate-x-[50%] p-2 w-[40%] flex justify-center flex-col items-center ">
          <h1 className="text-[4rem] font-mono leading-none tracking-tight  font-semibold">
            Apna Himachal
          </h1>

...
const TeamPlayet = ({ data, item }) => {
  ...
  return (
    <>
      <div
        key={Math.random()}
        className="bg-gradient-to-r  max-sm:hidden flex flex-col team-card hover:scale-[1.01] font-semibold  transition-all duration-300 ease-in-out  from-blue-500 to-teal-500 shadow-lg rounded-lg px-4 py-2    border-[2px] border-white font-mono col-span-4  text-white justify-start"
      >
      ...
      <div
        key={Math.random()}
        className="bg-gradient-to-r h-[100%]  flex justify-center  md:hidden flex-col team-card hover:scale-[1.01] font-semibold  transition-all duration-300 ease-in-out  from-blue-500 to-teal-500 shadow-lg rounded-lg px-4 py-2    border-[2px] border-white font-mono  text-white gap-2"
      >
        <div className="flex  items-center  ">
          <span className="">
            <img src={item.league.iconUrls.small} alt="" />
        ...
        <div className="flex gap-4">
          ...
          <span className="text-lg">
            <a
              target="_blank"
              className="bg-zinc-900 h-[90%] justify-center items-center mt-2 w-[140%] hover:bg-zinc-700 rounded-md flex  "
              href={`https://link.clashofclans.com/en?action=OpenPlayerProfile&tag=${item.tag}`}
            >
              Connect
            </a>
